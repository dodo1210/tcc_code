 ...
 */
public class VerticalThirdsFeatureTest {
    @Test
    public void extractFeature() throws Exception {
        ...
        MidiEvent uni_tracks1 = MidiBuildEvent.createNoteOnEvent(5, 1, 0);
        MidiEvent uni_tracks2 = MidiBuildEvent.createNoteOffEvent(5, 2, 0);
