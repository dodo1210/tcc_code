 ...
 */
public class VerticalTritonesFeatureTest {
    @Test
    public void extractFeature() throws Exception {
        ...
        MidiEvent uni_tracks1 = MidiBuildEvent.createNoteOnEvent(6, 1, 0);
        MidiEvent uni_tracks2 = MidiBuildEvent.createNoteOffEvent(6, 2, 0);
        ...
        MIDIFeatureExtractor unison = new VerticalTritonesFeature();
