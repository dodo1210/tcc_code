...
/**
 * A feature calculator that finds the magnitude of the tempo-standardized beat histogram peak with the
 * highest magnitude divided by the magnitude of the tempo-standardized beat histogram peak with the second
 * highest magnitude.
 *
 * @author Cory McKay
 */
public class StrengthRatioOfTwoStrongestRhythmicPulsesTempoStandardizedFeature
