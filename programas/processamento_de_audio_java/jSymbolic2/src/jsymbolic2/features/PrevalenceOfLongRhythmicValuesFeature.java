 ...
 * greater than a dotted quarter note. This includes both pitched and unpitched notes, is calculated after
 ...
 * @author Cory McKay
 */
public class PrevalenceOfLongRhythmicValuesFeature
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			value = rhythmic_value_histogram[6] + rhythmic_value_histogram[7] + rhythmic_value_histogram[8] +
			        rhythmic_value_histogram[9] + rhythmic_value_histogram[10] + rhythmic_value_histogram[11];
		}
		else value = -1.0;
