 ...
 * @author Cory McKay
 */
public class RhythmicValueMedianRunLengthsHistogramFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public RhythmicValueMedianRunLengthsHistogramFeature()
	{
		code = "R-33";
		String name = "Rhythmic Value Median Run Lengths Histogram";
