...
/**
 * A feature calculator that finds the mean number of notes of the same rhythmic value that occur
 ...
 * @author Cory McKay
 */
public class MeanRhythmicValueRunLengthFeature
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			value = mckay.utilities.staticlibraries.MathAndStatsMethods.getAverage(array_of_all_runs_of_same_rhythmic_value);
		}
		else value = -1.0;
