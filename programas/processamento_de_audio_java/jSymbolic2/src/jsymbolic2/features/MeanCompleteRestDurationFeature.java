...
/**
 * A feature calculator that calculates the mean duration of complete rests in the piece, expressed as a
 ...
 * @author Cory McKay
 */
public class MeanCompleteRestDurationFeature
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			if (sequence_info.complete_rest_durations == null)
				...
				value = mckay.utilities.staticlibraries.MathAndStatsMethods.getAverage(sequence_info.complete_rest_durations);
		}
		else value = -1.0;
