 ...
 * that occur consecutively (either vertically or horizontally) in the same voice (MIDI channel and track).
 * This calculation includes both pitched and unpitched notes, is calculated after rhythmic quantization and
 * not influenced by neither tempo nor dynamics.
 * * 
 * @author Cory McKay
 */
