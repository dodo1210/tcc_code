 ...
 * @author Cory McKay
 */
public class SimpleInitialMeterFeature
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			if ( initial_time_signature_numerator == 2.0 || initial_time_signature_numerator == 3.0 ||
			     initial_time_signature_numerator == 4.0 )
				value = 1.0;
		}
