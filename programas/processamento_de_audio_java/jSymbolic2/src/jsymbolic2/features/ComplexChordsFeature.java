...
/**
 * A feature calculator that finds the fraction of all simultaneously sounding pitch groups that contain more
 * that four pitch classes. This is weighted by how long pitch groups are held (e.g. a pitch group lasting a
 * whole note will be weighted four times as strongly as a pitch group lasting a quarter note).
 *
*
 * @author Tristano Tenaglia and Cory McKay
 */
public class ComplexChordsFeature 
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			value = chord_type_histogram[ChordTypeEnum.COMPLEX_CHORD.getChordTypeCode()];			
		}
		else value = -1.0;
