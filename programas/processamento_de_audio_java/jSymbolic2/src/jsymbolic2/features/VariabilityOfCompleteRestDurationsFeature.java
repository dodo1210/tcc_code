 ...
 * @author Cory McKay
 */
public class VariabilityOfCompleteRestDurationsFeature
		extends MIDIFeatureExtractor
{
	 ...
	 */
	public VariabilityOfCompleteRestDurationsFeature()
	{
		code = "R-50";
		String name = "Variability of Complete Rest Durations";
		String description = "Standard deviation of the durations of all complete rests in the piece, expressed as a fraction of the duration of a quarter note. A complete rest is defined as a period in which no pitched notes are sounding on any MIDI channel. Non-pitched (MIDI channel 10) notes are not considered in this calculation. Rests shorter than 0.1 of a quarter note are ignored in this calculation.";
