		...
		extends DefaultHandler
{
	...
	/**
	 * Whether or not to extract and save metadata from Music Brainz web
	 * services.
	 */
	public boolean save_music_brainz_metadata;
			...
			throws Exception
	{
		try
		{
			...
			writer.write("\t<!ELEMENT save_music_brainz_metadata (#PCDATA)>\n");
			...
			writer.write("\t<save_music_brainz_metadata>" + save_music_brainz_metadata + "</save_music_brainz_metadata>\n");
	...
	public void testPublicFieldValues(PrintStream to_write)
	{
		...
		if (!save_echo_nest_metadata && !save_last_fm_metadata && !save_music_brainz_metadata && !save_embedded_metadata)
	...
	private void setPublicFieldsToDefaults()
	{
		...
		save_music_brainz_metadata = true;
	...
	private void refreshParsingFields()
	{
		...
		parsing_state.put("save_music_brainz_metadata", new Boolean(false));
			...
			throws SAXException
	{
		...
		else if (parsing_state.get("save_music_brainz_metadata"))
			save_music_brainz_metadata = (new Boolean(text)).booleanValue();
