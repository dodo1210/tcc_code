...
public class DublinCoreInterpreter
{
	...
	public static Vector<MusicMetaData> getSongUnqualifiedDublinCore(Vector<MusicMetaData> song_metadata)
	{
		...
		alt_fields = new String[13];
		alt_fields[0] = "Last.FM Track Wiki Summary";
		alt_fields[1] = "Echo Nest Analysis URL";
		alt_fields[2] = "Comment";
		alt_fields[3] = "Duration (seconds)";
		alt_fields[4] = "Tempo (BPM)";
		alt_fields[5] = "Time Signature";
		alt_fields[6] = "Key";
		alt_fields[7] = "Mode";
		alt_fields[8] = "Loudness (-100 to 100 dB)";
		alt_fields[9] = "Last.FM Track Play Count";
		alt_fields[10] = "Echo Nest Song Hottness (0 to 1)";
		alt_fields[11] = "Echo Nest Danceability (0 to 1)";
		alt_fields[12] = "Echo Nest Energy (0 to 1)";
		...
		alt_fields[0] = "Echo Nest Release Name";
		alt_fields[1] = "Echo Nest Song ID";
		alt_fields[2] = "Last.FM Track URL";
		alt_fields[3] = "7digital-US Song ID";
		alt_fields[4] = "MusicIP Song ID";
		alt_fields[5] = "Amazon Song ID";
		alt_fields[6] = "Song Barcode";
		alt_fields[7] = "Audio Source File";
		alt_fields[8] = "ENMF Fingerprint Hash Output by the Echo Nest Fingerprinting Codegen Binary";
		...
		alt_fields[1] = "Song Release List";
		alt_fields[2] = "Lyrics";
		alt_fields[3] = "Lyrics URL";
	...
	public static Vector<MusicMetaData> getArtistUnqualifiedDublinCore(Vector<MusicMetaData> artist_metadata)
	{
		...
		String[] alt_fields;
		alt_fields = new String[1];
		alt_fields[0] = "Artist Alias";
		addToAlternateMappings("dc.Title", alt_fields, alternate_mappings);
		alt_fields = new String[1];
		...
		alt_fields[2] = "Facebook Artist ID";
		alt_fields[3] = "7digital Artist ID";
		alt_fields[4] = "Play.me Artist ID";
		alt_fields[5] = "Rdio-US Artist ID";
		addToAlternateMappings("dc.Identifier", alt_fields, alternate_mappings);
		alt_fields = new String[6];
		alt_fields[0] = "Top Albums";
		alt_fields[1] = "Artist-Related Song";
		alt_fields[2] = "Artist-Related Audio";
		alt_fields[3] = "Artist-Related Video";
		alt_fields[4] = "Artist-Related Image";
		alt_fields[5] = "Similar Artist";
		addToAlternateMappings("dc.Relation", alt_fields, alternate_mappings);
		alt_fields = new String[5];
		alt_fields[0] = "Artist Event";
		alt_fields[1] = "Artist-Related News";
		alt_fields[2] = "Artist-Related Blog";
		alt_fields[3] = "Years Active";
		alt_fields[4] = "Lifespan";
		addToAlternateMappings("dc.Coverage", alt_fields, alternate_mappings);
	...
	public static Vector<MusicMetaData> getAlbumUnqualifiedDublinCore(Vector<MusicMetaData> album_metadata)
	{
		...
		String[][] identifier_mappings =
		{
			...
			{"dc.Type","Release Type"},
			{"dc.Identifier","Music Brainz Album ID"},
			{"dc.Relation","Track List"},
		...
		alt_fields[1] = "Number of Tracks";
		alt_fields[2] = "Last.FM Album Play Count";
		addToAlternateMappings("dc.Description", alt_fields, alternate_mappings);
		alt_fields = new String[1];
		alt_fields[0] = "Album-Related Tag";
		addToAlternateMappings("dc.Type", alt_fields, alternate_mappings);
		alt_fields = new String[2];
		alt_fields[0] = "Last.FM Album URL";
		alt_fields[1] = "Amazon Album ID";
		addToAlternateMappings("dc.Identifier", alt_fields, alternate_mappings);
	...
	public static Vector<MusicMetaData> getSongQualifiedDublinCore(Vector<MusicMetaData> song_metadata)
	{
		String[][] identifier_mappings =
		{
			...
			{"dc.Title^echonestreleasename","Echo Nest Release Name"},
			...
			{"dc.Description^echonestdanceability","Echo Nest Danceability (0 to 1)"},
			{"dc.Description^echonestsongenergy","Echo Nest Energy (0 to 1)"},
			{"dc.Description^echonestanalysisurl","Echo Nest Analysis URL"},
			...
			{"dc.Identifier^7digitalussongid","7digital-US Song ID"},
			...
			{"dc.Relation^songrelease","Song Release"},
	...
	public static Vector<MusicMetaData> getArtistQualifiedDublinCore(Vector<MusicMetaData> artist_metadata)
	{
		String[][] identifier_mappings =
		{
			...
			{"dc.Title^artistalias","Artist Alias"},
			...
			{"dc.Identifier^rdiousartistid","Rdio-US Artist ID"},
			{"dc.Identifier^facebookartistid","Facebook Artist ID"},
			{"dc.Relation^toptracks","Top Tracks"},
			{"dc.Relation^artistrelatedsong","Artist-Related Song"},
			...
			{"dc.Coverage^yearsactive","Years Active"},
			{"dc.Coverage^lifespan","Lifespan"},
	...
	public static Vector<MusicMetaData> getAlbumQualifiedDublinCore(Vector<MusicMetaData> album_metadata)
	{
		String[][] identifier_mappings =
		{
			...
			{"dc.Relation^tracklist","Track List"},
			{"dc.Identifier^amazonalbumid","Amazon Album ID"},
