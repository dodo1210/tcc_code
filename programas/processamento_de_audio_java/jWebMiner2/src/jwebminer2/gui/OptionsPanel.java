 ...
 *
 * <p>- The <i>Yahoo!</i> checkbox controls whether the Yahoo! REST-like Web
 ...
 * to each user.
 *
 * <p>- The <i>Google</i> checkbox controls whether the Google SOAP web services
 ...
 *
 * <p>- The <i>Treat strings literally</i> checkbox controls whether all search
 ...
 *
 * <p>- The <i>Perform search as OR instead of AND</i> checkbox controls whether
 ...
 * unchecked.
 *
 * <p>- The <i>Include non-matching similar hits</i> checkbox controls whether
 ...
 *
 * <p>- The <i>Suppress similar hits</i> checkbox controls whether to suppress
 ...
 * same host.
 *
 * <p>- The <i>Suppress adult content</i> checkbox controls whether to suppress
 * hits that are classified as containing adult content by the search service in
 * question.
 *
 * <p>- The <i>Limit to language</i> combo box field sets the name of a language
 * that hits must be in in order to be included in search results.
 *
 * <p>- The <i>Limit to country</i> combo box field sets the name of a country
 * that sites must be in in order to be included in search results.
 *
 * <p>- The <i>Search from region</i> combo box field sets the name of a country
 ...
 *
 * <p>- The <i>Limit to file type</i> combo box field sets the name of a file
 ...
 *
 * <p>The Co-Occurrence Scoring Function options control which formula is
 ...
 *
 * <p>- S(a1,a2) = PC(a1,a2) / (1 + (SUMcfromAcnota1(PC(a1,c)) x SUMdfromAdnota2(PC(d,a2))))
 *
 * <p>- S(a1,a2, c) = (PC(a1,a2) / PC(a2)) * (1 - (|PC(a1) - PC(a2)| / PC(c))) where c is the greatest PC(A)
 *
 * <p>- The Cross-Tabulation Scoring Function options control which formula is
 ...
 * below. In brief, these are:
 *
 * <p>- S(a,b) = PC(a,b) / PC(a)</p>
 *
 * <p>- S(a,b) = PC(a,b) / PC(b)</p>
 *
 * <p>- S(a,b) = PC(a,b) / (1 + SUMcfromA(PC(c,b)))</p>
 *
 * <p>- S(a,b) = PC(a,b) / (1 + SUMcfromB(PC(a,c)))</p>
 *
 * <p>- The <i>Feature scores</i> checkbox controls whether or not to display the
 * final scores that will be saved as features in the Results Panel after
 * processing is complete.
 *
 * <p>- The <i>Combined processed hit counts</i> checkbox controls whether or not
 ...
 *
 * <p>- The <i>Combined raw hit counts</i> checkbox controls whether or not to
 ...
 *
 * <p>- The <i>Individual raw hit counts</i> checkbox controls whether or not to
 ...
 *
 * <p>- The <i>Search queries used</i> checkbox controls whether or not to
 ...
 *
 * <p>- The <i>Search settings used</i> checkbox controls whether or not to
 ...
 *
 * <p>- S() refers to the output scoring function.
 *
 * <p>- a (from set A) refers to an element from the Primary Search Strings field
 * in the Search Words Panel.
 *
 * <p>- b (from set B) refers to an element from the Secondary Search Strings
 * field in the Search Words Panel.
 *
 * <p>- C() refers to the combined hit counts accross web services and weighted
     ...
     implements ActionListener
{
      ...
      *
      * <p>display_feature_scores
      * - display_combined_raw_counts
      * - display_individual_raw_counts
      * - display_queries_used
      * - display_search_settings_used
      * - display_combined_processed_counts_checkbox
      *
