...
public class Statistics
{
	 ...
	 * @param	z	The possible multipliers to check for.
	 * @return		Whether or not x or y are factors or multiples of each
	 *				other, within the given constraints.
	 */
	 ...
	 * @return		The distance.
	 * @throws	Exception	If the arrays have different sizes.
	 */
	 ...
	 * 
	 * @param	max	The non-inclusive ceiling.
	 ...
	 * 
	 * @param	number_entries	The non-inclusive ceiling.
	 ...
	 *
	 * @param	to_normalize	The arrays to normalize.
