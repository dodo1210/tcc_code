 ...
 *
 * <p>1) Directory path to parse for lyrics files
 * <p>2) File path to save ACE XML 1.1 Feature Values file to
 * <p>3) File path to save ACE XML 1.1 Feature Definitions file to
 *
 * <p>OR
 *
 * <p>1) Directory path to parse for lyrics files
 * <p>2) File path to save Weka ARFF file to
 *
 * <p>OR (for generating profiles)
 * 
 * <p>1) -profile
 * <p>2) Directory path to parse for lyrics files
 * <p>3) Path to save generated report to
 *
 * <p>OR (for generating profiles)
 * 
 * <p>1) -profile
 * <p>2) Directory path to parse for lyrics files
 * <p>3) Path of a file specifying unique classes
 * <p>4) Path of a file specifying instance classes
 * <p>5) Path of a file specifying instance identifiers
 * <p>6) Path to save generated reports to
 * 
 * @author Cory McKay
 */
public class Main
