...
#print(scores)
X_train, X_test, y_train, y_test = train_test_split(selecao, y, test_size=0.2)
...
for i in range(20):
    ...
    soma+=metrics.accuracy_score(y_test, y_pred)
